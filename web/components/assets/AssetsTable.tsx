  ...
  return (
    <>
      ...
      <div className="md:hidden space-y-2">
        {assets.map(a => (
          <div key={a.id} onClick={() => onNavigate(a)}
            ...
            <div className="flex justify-between items-start">
              ...
              {a.symbol && (
                <span className="ml-3 shrink-0 px-2 py-0.5 bg-[var(--color-text)] text-[var(--color-surface)] rounded-full text-xs font-bold">
                  {a.symbol}
                </span>
              )}
            </div>
            ...
            {assets.map((a, i) => (
              <tr key={a.id} onClick={() => onNavigate(a)}
                ...
                <td className="px-4 py-3 whitespace-nowrap">
                  {a.symbol
                    ? <span className="px-2 py-0.5 bg-[var(--color-text)] text-[var(--color-surface)] rounded-full text-xs font-bold">{a.symbol}</span>
